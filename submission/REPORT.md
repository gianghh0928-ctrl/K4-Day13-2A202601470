...
| 5   | Sửa Repository URL trong báo cáo                                                                                                  | mục 1                                                                                                                                                                                                                                        | `git remote` còn trỏ tên cũ `Day13-K4-...` và chỉ chạy được nhờ GitHub redirect; tên repo chính thức hiện tại là `K4-Day13-...`. Theo SUBMISSION.md, sai loại URL bị coi là bài nộp chưa hợp lệ nên báo cáo dùng URL chính tắc                                                                                                                                                                                                                                                                                    |
